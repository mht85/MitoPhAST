...
CONTACT
=======
Tan Mun Hua <mun.tan@deakin.edu.au>
...
Example: ./run_MitoPhASTv1.sh -i example/input/ -n HG942366,HG799086 -T 15 -O COX1
...
-b <int>	number of ultrafast bootstrap replicates run on IQ-TREE (default: 1000, must be >= 1000)
-a <int>	number of SH-aLRT replicates run on IQ-TREE (default: 1000)
-T <int>	number of threads (default: 1)
-O <string>	gene to orient to for linear gene order comparison analysis (if not provided, analysis is skipped), see README for allowed genes
...
Final tree from IQ-TREE analysis with SH-aLRT and ultrafast bootstrap support values can be found in the ml_analysis folder in the MLtree.renamed.tre.
...
$PATH/example/input-out/gene_orders/
---------------------------------
Grouping of mitochondrial gene orders (MGOs) in FASTA and PDF output files
